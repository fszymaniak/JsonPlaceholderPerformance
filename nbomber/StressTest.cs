...
public static class StressTest
{
    ...
    public static void Run()
    {
        ...
        var createPost = Step.Create("POST /posts", async context =>
        {
            var body = $$$"""
                {
                    "title": "Stress test post {{{Random.Shared.Next(1000)}}}",
        ...
        var scenario = ScenarioBuilder
            .CreateScenario("Stress Test", getPosts, getPost, createPost)
            ...
            .WithLoadSimulations(
                ...
                Simulation.RampingInject(rate: 150, interval: TimeSpan.FromSeconds(1), during: TimeSpan.FromMinutes(2)),
                Simulation.Inject(rate: 150, interval: TimeSpan.FromSeconds(1), during: TimeSpan.FromMinutes(3)),
